...
export default function AdminRecipesPage() {
  ...
  const validateForm = (): boolean => {
    ...
    if (recipe.calories <= 0) newErrors.calories = "Calories must be a positive number"
    if (recipe.labels.length === 0) newErrors.labels = "At least one label is required"
    if (recipe.servings <= 0) newErrors.servings = "Servings must be a positive number"
    if (recipe.prepTime <= 0) newErrors.prepTime = "Prep time must be a positive number"
    ...
    <div className="h-screen pt-2 pb-10 overflow-y-auto">
      <Card className="w-full max-w-4xl mx-auto">
        <CardHeader className="py-5 pb-1">
          ...
          <CardDescription>Create a new recipe for the meal tracker app.</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={onSubmit} className="flex flex-col gap-4">
            <div>
              ...
              <Input
                ...
                value={recipe.label}
                onChange={(e) => updateRecipe("label", e.target.value)}
              />
                ...
                <div key={index} className="flex items-end gap-4 mt-2">
                  ...
                  <div>
                    <Input
                      ...
                      onChange={(e) => updateIngredient(index, "weight", Number.parseFloat(e.target.value))}
                    />
                  </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => updateRecipe("calories", Number.parseFloat(e.target.value))}
                />
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => updateRecipe("servings", Number.parseInt(e.target.value))}
                />
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Macros</label>
              <div className="grid grid-cols-3 gap-4 mt-2">
                <Input
                  type="number"
                  placeholder="Fat (g)"
                  value={recipe.macros.fat || ""}
                  onChange={(e) => updateRecipe("macros", { ...recipe.macros, fat: Number.parseFloat(e.target.value) })}
                />
                <Input
                  type="number"
                  placeholder="Carbs (g)"
                  ...
                  onChange={(e) =>
                    updateRecipe("macros", { ...recipe.macros, carbs: Number.parseFloat(e.target.value) })
                  }
                />
                <Input
                  type="number"
                  ...
                  onChange={(e) =>
                    updateRecipe("macros", { ...recipe.macros, protein: Number.parseFloat(e.target.value) })
                  }
                />
              </div>
            </div>
            ...
            <div>
              ...
              <Select value={recipe.mealType} onValueChange={(value) => updateRecipe("mealType", value)}>
                <SelectTrigger>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => updateRecipe("prepTime", Number.parseInt(e.target.value))}
              />
            ...
            <div>
              ...
              {errors.labels && <p className="mt-1 text-sm text-red-600">{errors.labels}</p>}
            </div>
