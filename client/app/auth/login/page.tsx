			...
			<div className="w-full max-w-3xl bg-white/5 rounded-2xl shadow-lg overflow-hidden">
				<form onSubmit={handleSubmit} className="p-8">
					...
					<div className="mt-8 flex justify-between">
						<Button
							type="submit"
							className="px-4 py-2 text-sm font-medium text-white bg-primary/90 border border-transparent rounded-md shadow-sm hover:bg-primary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
						>
							Submit
						</Button>
					</div>
